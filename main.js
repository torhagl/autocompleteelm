...
var _user$project$Main$viewAlternatives = F2(
	function (input, db) {
		return A2(
			...
			_0: A2(
				...
				},
				{
					...
					_0: A2(
						...
						{
							ctor: '::',
							_0: _elm_lang$html$Html_Attributes$class('col col-12'),
							_1: {ctor: '[]'}
						},
						{
							ctor: '::',
							_0: A2(
								...
								{
									ctor: '::',
									_0: _elm_lang$html$Html_Attributes$placeholder('Start typing!'),
									_1: {
										ctor: '::',
							...
							_1: {
								...
								_0: A2(
									...
									{
										ctor: '::',
										_0: _elm_lang$core$Native_Utils.eq(model.input, '') ? _elm_lang$html$Html$text('Results come here!') : A2(_user$project$Main$viewAlternatives, model.input, _user$project$Main$db),
										_1: {ctor: '[]'}
									}),
								_1: {ctor: '[]'}
							}
